...
async function runAllTests() {
    ...
    const testCases = [
        { message: 'Test|KO6BVA|FN42kl|555-1234&=Hello World', name: 'Basic Message' },
        { message: 'Alice|W1ABC|FN31pr|555-0001&=Test 123', name: 'Different User' },
        { message: 'Bob|K9XYZ|EM48qv|555-9999&=Short', name: 'Short Message' },
        { message: 'Charlie|VE3TEST|FN25dk|555-5555&=This is a longer message to test buffer handling', name: 'Long Message' },
        { message: 'Dave|G4ABC|IO91wl|555-7777&=Special chars: !@#$%', name: 'Special Characters' },
    ];
...
async function runQuickTest() {
    ...
    await testEncodeDecodeRoundTrip('Test|KO6BVA|FN42kl|555-1234&=Quick test message', 'Quick Test');
...
async function runStressTest() {
    ...
    for (let i = 0; i < 10; i++) {
        const message = `Stress${i}|TEST${i}|FN42kl|555-${i.toString().padStart(4, '0')}&=Stress test message ${i + 1}`;
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('testMessage').value = 'Test|KO6BVA|FN42kl|555-1234&=Hello World';
});
