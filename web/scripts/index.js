...
if ("serviceWorker" in navigator) {
    ...
    loadPromise
        ...
        const init = () => {
            ...
            const FEED_LENGTH =
            wasmExports["feed_length"]() * Float32Array.BYTES_PER_ELEMENT;
            ...
            wasmExports["payload_length"]() * Uint8Array.BYTES_PER_ELEMENT;
            ...
            wasmExports["message_length"]() * Uint8Array.BYTES_PER_ELEMENT;
            ...
            const SIGNAL_LENGTH =
            wasmExports["signal_length"]() * Float32Array.BYTES_PER_ELEMENT;
            ...
            console.log(
                "encoding message:",
                wasmExports["initEncoder"] === undefined ? "failed" : "success"
            );
    ...
    if (
        ...
        const a =
            cs.charCodeAt(0) * 11 + cs.charCodeAt(1) * 7 + cs.charCodeAt(2) * 3;
        const h = a % 360;
