...
5. Manual compilation:
   ```bash
   emcc src/ribbit/src/ribbit.cc -o web/ribbit.js -s WASM=1 -s EXPORTED_RUNTIME_METHODS=['ccall','cwrap'] -s EXPORTED_FUNCTIONS=['_malloc','_free'] -I src/ribbit/include -std=c++17 -O2
   ```
